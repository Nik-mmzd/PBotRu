...
$.lang.register('chatmoderator.spam.usage', 'Использование: !moderation spam [on / off] (spam filter is currently $1)');
...
$.lang.register('chatmoderator.symbols.usage', 'Использование: !moderation symbols [on / off] (symbol filter is currently $1)');
...
$.lang.register('chatmoderator.emotes.usage', 'Использование: !moderation emotes [on / off] (emote filter is currently $1)');
...
$.lang.register('chatmoderator.colors.usage', 'Использование: !moderation colors [on / off] (colors filter is currently $1)');
